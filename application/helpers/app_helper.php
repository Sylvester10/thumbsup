...
function nigerian_states() {
	...
	function x_dates($date) { //format date in the form eg 23rd Aug, 2018 from timestamp in db
	...
	function x_time_period($date) { //eg 05:20 PM
		return date("A", strtotime($date));
	}

	function x_time_12hours($date) { //eg 05:20
