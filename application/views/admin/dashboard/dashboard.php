	...
	<div class="row m-b-50">
		...
		<div class="animated flipInY col-lg-3 col-md-6 col-sm-6 col-xs-12">
			<div class="tile-stats custom-bg-blue">
				...
				<div class="count"><?php echo $profiles; ?></div>
		...
		<div class="animated flipInY col-lg-3 col-md-6 col-sm-6 col-xs-12">
			<div class="tile-stats custom-bg-blue">
				...
				<div class="count"><?php echo $volunteer; ?></div>
		...
		<div class="animated flipInY col-lg-3 col-md-6 col-sm-6 col-xs-12">
			<div class="tile-stats custom-bg-blue">
				...
				<div class="count"><?php echo $structures; ?></div>
				<h3 class="stats-title">Structures</h3>
			</div>
		</div>
		<div class="animated flipInY col-lg-3 col-md-6 col-sm-6 col-xs-12">
			<div class="tile-stats custom-bg-blue">
				<div class="icon"><i class="fa fa-cubes"></i></div>
				<div class="count"><?php echo $units; ?></div>
				<h3 class="stats-title">Units</h3>
			</div>
		</div>
