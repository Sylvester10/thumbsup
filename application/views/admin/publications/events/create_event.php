	...
	<div class="row">
		...
		<div class="col-md-7 col-sm-12 col-xs-12">
			...
			<div class="form-group">
				...
				<input type="text" name="zoom_link" class="form-control" value="<?php echo set_value('zoom_link'); ?>" required />
			</div>

			<div class="form-group">
				<label class="form-control-label">Google Form Link</label>
				<input type="text" name="google_form" class="form-control" value="<?php echo set_value('google_form'); ?>" required />
			</div>
