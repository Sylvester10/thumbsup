			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Delete: <?php echo $y->fullname; ?></h4>
					</div><!--/.modal-header-->
					...
					<div class="modal-footer">
						<a class="btn btn-sm btn-danger" role="button" href="<?php echo base_url('profiles/delete_profile/'.$y->id); ?>"> Yes, Delete </a>
