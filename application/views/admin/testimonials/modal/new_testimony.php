		...
		<div class="modal-dialog">
			<div class="modal-content modal-form-sm">
				...
				<div class="modal-body">
					...
					echo form_open_multipart('testimonial/add_new_testimonial_ajax', $form_attributes); ?>
						...
						<div class="form-group">
							...
							<br/>
							<input type="text" name="position" value="<?php echo set_value('position'); ?>" class="form-control" required />
