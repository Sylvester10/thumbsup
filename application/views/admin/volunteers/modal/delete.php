			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Delete: <?php echo $y->name; ?></h4>
					</div><!--/.modal-header-->
					...
					<div class="modal-footer">
						<a class="btn btn-sm btn-danger" role="button" href="<?php echo base_url('volunteers/delete_volunteer/'.$y->id); ?>"> Yes, Delete </a>
