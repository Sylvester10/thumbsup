...
class Events_model extends CI_Model {
	...
	public function make_single_event($y){
		...
		$main_page = '<div id="epage">
            ...
            <span id="epage_title_bottom">Published '.time_ago($y->date_created).' on '.x_date($y->date_created).' By <b>Thumbs-Up Organization</b></span>
            ...
            <div id="epage_details_container">
                <div id="epage_details_container_inner">
                    <div id="epage_detail">
                        <h3>Date</h3>
                        <span>'.x_day_ordinal($y->date_created).' '.x_month_long($y->date_created).' <span> '.x_year_long($y->date_created).'</span></span>
                    </div>
                    <div id="epage_detail">
                        <h3>Time</h3>
                        <span>'.x_time_12hours($y->date_created).' <span> '.x_time_period($y->date_created).'</span></span>
                    </div>
                    <div id="epage_detail">
                        <h3>Location</h3>
                        <span>'.$y->venue.'</span>
