...
class MY_Controller extends CI_Controller {
	...
	public function about_header($title) {
		$data['title'] = $title;
		return $this->load->view('layout/about_header', $data);
	}

	public function arms_header($title) {
		$data['title'] = $title;
		return $this->load->view('layout/arms_header', $data);
	}

	public function board_header($title) {
		$data['title'] = $title;
		return $this->load->view('layout/board_header', $data);
	}

	public function volunteer_header($title) {
		$data['title'] = $title;
		return $this->load->view('layout/volunteer_header', $data);
	}	

	public function event_header($title) {
		$data['title'] = $title;
		return $this->load->view('layout/event_header', $data);
	}

	public function gallery_header($title) {
		$data['title'] = $title;
		return $this->load->view('layout/gallery_header', $data);
	}

	public function blog_header($title) {
		$data['title'] = $title;
		return $this->load->view('layout/blog_header', $data);
	}

	public function contact_header($title) {
		$data['title'] = $title;
		return $this->load->view('layout/contact_header', $data);
	}

	public function error_header($title) {
		$data['title'] = $title;
		return $this->load->view('layout/error_header', $data);
	}
